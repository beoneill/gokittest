...
import (
	...
	grpc "github.com/beoneill/gokittest/flights/pkg/grpc"
...
var fs = flag.NewFlagSet("flights", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "flights")
...
func initGRPCHandler(endpoints endpoint.Endpoints, g *group.Group) {
	...
	g.Add(func() error {
		...
		pb.RegisterFlightsServer(baseServer, grpcServer)
